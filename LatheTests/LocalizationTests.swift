...
final class LocalizationTests: XCTestCase {
    ...
    func test_koreanLocalizationProvidesCoreUserFacingStrings() throws {
        ...
        XCTAssertEqual(bundle.localizedString(forKey: "settings.search", value: nil, table: nil), "검색")
    ...
    func test_englishLocalizationProvidesCoreUserFacingStrings() throws {
        ...
        XCTAssertEqual(bundle.localizedString(forKey: "settings.search", value: nil, table: nil), "Search")

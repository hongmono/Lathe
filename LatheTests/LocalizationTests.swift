...
final class LocalizationTests: XCTestCase {
    ...
    func test_koreanLocalizationProvidesCoreUserFacingStrings() throws {
        ...
        XCTAssertEqual(bundle.localizedString(forKey: "settings.carousel.animateOnOpen", value: nil, table: nil), "열릴 때 카드 펼치기")
        XCTAssertEqual(bundle.localizedString(forKey: "settings.animation.section", value: nil, table: nil), "애니메이션")
        XCTAssertEqual(bundle.localizedString(forKey: "settings.carousel.windowListAnimation", value: nil, table: nil), "창 목록 애니메이션")
        XCTAssertEqual(bundle.localizedString(forKey: "settings.carousel.windowListAnimation.speed", value: nil, table: nil), "애니메이션 속도")
        XCTAssertEqual(bundle.localizedString(forKey: "settings.animation.windowListAnimation.delay", value: nil, table: nil), "시작 지연")
        XCTAssertEqual(bundle.localizedString(forKey: "windowListAnimation.expand", value: nil, table: nil), "아래로 펼치기")
    ...
    func test_englishLocalizationProvidesCoreUserFacingStrings() throws {
        ...
        XCTAssertEqual(bundle.localizedString(forKey: "settings.carousel.animateOnOpen", value: nil, table: nil), "Animate cards when opening")
        XCTAssertEqual(bundle.localizedString(forKey: "settings.animation.section", value: nil, table: nil), "Animation")
        XCTAssertEqual(bundle.localizedString(forKey: "settings.carousel.windowListAnimation", value: nil, table: nil), "Window list animation")
        XCTAssertEqual(bundle.localizedString(forKey: "settings.carousel.windowListAnimation.speed", value: nil, table: nil), "Animation speed")
        XCTAssertEqual(bundle.localizedString(forKey: "settings.animation.windowListAnimation.delay", value: nil, table: nil), "Start delay")
        XCTAssertEqual(bundle.localizedString(forKey: "windowListAnimation.expand", value: nil, table: nil), "Expand")

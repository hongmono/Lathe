...
A small ⌘+Tab replacement that you can audit line by line and rebuild
with one command. Signed locally, no third-party permissions to worry
about beyond Accessibility.
